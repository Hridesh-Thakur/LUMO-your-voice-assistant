...
const commandDB = [
  ...
  { keywords: ['open cloude'], action: () => { window.open("https://claude.ai/", "_blank"); return "Opening Claude..."; } },
  { keywords: ['open cloud'], action: () => { window.open("https://claude.ai/", "_blank"); return "Opening Claude..."; } },
