...
window.addEventListener('load', () => {
  speak("Initializing LUMO...");
  wishMe();
});

// ================= COMMAND DATABASE =================
// Bas naya command add karna ho to yaha ek object push kar do.
// keywords: match karne ke liye phrases
// reply: static text, YA
// action: function jo dynamic response/kaam kare
const commandDB = [
